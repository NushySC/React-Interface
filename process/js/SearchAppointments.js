            ...
            <div className="input-group-btn">
              <button type="button" className="btn btn-primary dropdown-toggle"
                ...
                <ul className="dropdown-menu dropdown-menu-right">
                  <li><a href="#" id="MassageName" onClick={this.sortByHandelar}>Massage Name { this.props.orderBy === 'MassageName' ? <span className="glyphicon glyphicon-ok"></span> : null}</a></li>
                  ...
                  <li><a href="#" id="CustomerName" onClick={this.sortByHandelar}>Customer { this.props.orderBy === 'CustomerName' ? <span className="glyphicon glyphicon-ok"></span> : null}</a></li>
